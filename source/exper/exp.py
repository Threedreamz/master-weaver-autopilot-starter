...
CANNY_HIGH = 150
DILATE_ITER = 2
APPROX_EPSILON = 3  # contour simplification
SWEEP_SPEED = 2.1  # radians per second
SWEEP_WIDTH = math.radians(90)  # angular width of the sweep (radians)
SWEEP_RADIUS_THICKNESS = 1800  # thickness in pixels of radial band
...
class OverlayWindow(QtWidgets.QWidget):
    ...
    def update_frame(self):
        ...
        kernel = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (1, 4))  # larger kernel merges fine details
        ...
        simplified = []
        for cnt in contours:
            if cv2.contourArea(cnt) < 100:  # ignore tiny stuff
                continue
    ...
    def paintEvent(self, event):
        ...
        ring_radius = int(0.2 * min(self.width(), self.height()))
