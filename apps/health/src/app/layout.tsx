...
export const metadata: Metadata = {
  title: "AutoPilot Health Dashboard",
  description: "Real-time monitoring for CT scanner automation nodes",
};

const navItems = [
  { href: "/", label: "Overview", icon: "grid" },
  { href: "/nodes/ipad", label: "iPad", icon: "tablet" },
  { href: "/nodes/pi", label: "Pi", icon: "cpu" },
  { href: "/nodes/ctpc", label: "CT-PC", icon: "monitor" },
